...
public class ex12_1_search {
	...
	public static void main(String[] args) {
		...
		System.out.println("index = " + binarySearch1(5, 0, arr.length - 1));

		System.out.println();
		System.out.println("2. 반복을 이용한 이진 탐색");
		System.out.println("index = " + binarySearch2(5, 0, arr.length - 1));
	}

	// 재귀 구조 // 1, 3, 5, 7, 8, 10, 20, 35, 99, 100          10개,   8이 중간
	static int binarySearch1(int key, int low, int high) {
		...
		System.out.println("검색 횟수 : " + ex12_1_search.cnt);
